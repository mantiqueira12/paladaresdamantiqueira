...
- [ ] **Categorias:** manter **Personal chef service** como principal (usar no painel a tradução oferecida pelo autocomplete). Começar sem categoria adicional; testar depois somente **Serviço de catering/Caterer**, caso represente a operação real e os termos de busca mostrem demanda qualificada. Não usar Restaurante, Serviço de casamento, Organizador de eventos ou Entrega. *As quatro categorias adicionais antigas foram removidas em 2026-07-19; o Google ainda precisa revisar/publicar a alteração antes deste item ser marcado como concluído.*
- [ ] **Área de atendimento:** configurar como negócio a domicílio e ocultar o endereço residencial. Cadastrar separadamente apenas cidades realmente atendidas e dentro do raio operacional a partir da base verificada — nunca usar combinações como “Monte Verde/Camanducaia”. Começar pelas cidades já publicadas no site e confirmar o tempo real de deslocamento de cada uma antes de ampliar. *Endereço oculto confirmado; Monte Verde foi enviada pela opção oficial “Monte Verde, Camanducaia - MG” do Google em 2026-07-19 e aguarda revisão. Demais cidades já haviam sido validadas pelo Rafael.*
- [ ] **Serviços:** cadastrar as **14 experiências públicas** como serviços (nome + descrição até 300 chars citando a porta de ocasião; preço = "entre em contato"). Cadastrar **"Só o Serviço" COM preço R$ 100/hora** (única camada com preço público — decisão fechada, doc 09). A Feijoada entra somente quando sua ficha for ativada. *Os 15 serviços e suas descrições foram salvos em 2026-07-19 e aguardam revisão/publicação. Como o painel não oferece unidade horária, Só o Serviço ficou com R$ 100/h e mínimo de 3h explícitos na descrição e “a partir de R$ 300” no campo estruturado.*
- [ ] **Descrição (750 chars):** usar o texto pronto do Apêndice A.1. *Enviada em 2026-07-19; aguarda revisão do Google antes de marcar como concluída.*
- [ ] **Atributos:** revisar Editar perfil → Mais; marcar "agendamento obrigatório", "orçamentos on-line", empresa familiar (se disponível). *Revisado em 2026-07-19: esses três atributos não foram oferecidos para a categoria. “Não faz entrega” e português/inglês foram enviados e aguardam revisão do Google.*
- [ ] **Link do site com UTM:** `https://paladaresdamantiqueira.com.br/?utm_source=gbp&utm_medium=organic&utm_campaign=perfil` · telefone idêntico ao do site/IG (consistência NAP). *Link enviado e telefone/WhatsApp confirmados em 2026-07-19; aguarda revisão do Google antes de marcar como concluído.*
- [x] **Perfil duplicado:** auditoria somente leitura concluída em 2026-07-19. O canônico confirmado possui `fid=2962189963480408793`; o segundo cadastro não possui `fid`/link público na lista e o próprio painel o identifica como **“NÃO VISÍVEL PUBLICAMENTE”** e “Verificação obrigatória”. Preservado sem excluir, encerrar, verificar ou mesclar; não há evidência de concorrência pública com o perfil oficial neste momento.
