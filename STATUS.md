...
**Próximo marco:** concluir a ficha do estrogonofe de carne para 10 porções com 5–10 insumos, rendimento, peso bruto e custo conferidos. Só então definir stack, banco, autenticação e implantação do app interno.
